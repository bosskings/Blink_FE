...
import { useVerifyPhone, useResendOtp } from "@/services";
    ...
    <SafeAreaView style={styles.viewport}>
      ...
      <View style={styles.container}>
        ...
        <Text style={styles.subtitle}>
          ...
          <Text style={styles.boldText}>{userPhone || "your phone"}</Text>
        </Text>
